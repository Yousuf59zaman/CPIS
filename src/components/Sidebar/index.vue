...
<template>
  <div class="contents">
    ...
    <!-- Sidebar Content -->
    <div
      class="fixed lg:static inset-y-0 left-0 w-[280px] sm:w-[300px] lg:w-full bg-white lg:bg-transparent flex flex-col pt-0 pb-10 z-[70] lg:z-auto shadow-2xl lg:shadow-none transition-transform duration-300 ease-in-out lg:transition-none transform overflow-y-auto"
      :class="[isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0']"
    >
      <!-- Logo Area -->
      <div class="px-[5px] lg:px-[8px] 2xl:px-[10px] mb-[35px] 2xl:mb-[50px] w-full">
        <img
          src="@/assets/icons/sidebar/Logo Workflow.svg"
          alt="CPIS Logo"
          class="h-[100px] 2xl:h-[110px] w-auto max-w-full object-contain"
        />
      </div>

      <!-- Navigation Menu -->
      <nav
        class="flex-1 px-[20px] 2xl:px-[26px] xl:pt-3 2xl:pt-5 flex flex-col gap-[12px] 2xl:gap-[18px]"
      >
        <router-link
