  ...
  <main class="flex flex-col gap-[16px] 2xl:gap-[20px] p-[20px] 2xl:p-[24px] font-['Poppins']">
    ...
    <div class="bg-white rounded-[12px] border border-[#f0f0f0] shadow-sm overflow-hidden">
      ...
      <div v-if="showSupportingDocs" class="px-[20px] pb-[16px]">
        ...
        <button class="px-[14px] py-[8px] bg-[#1d4a1d] hover:bg-[#163a16] text-white text-[16px] leading-[32px] font-medium rounded-[7px] transition-colors">
    ...
    <div class="bg-white rounded-[12px] border border-[#f0f0f0] shadow-sm p-[20px]">
      <div class="flex items-center gap-[10px] mb-[14px]">
        <div class="w-[4px] h-[18px] bg-[#224e22] rounded-full"></div>
        <h2 class="text-[30px] leading-[45px] font-normal text-[#234F23]">Final Decision <span class="text-[16px] leading-[24px] font-light text-[#d0272a] ml-[4px]">(Mandatory Selection)</span></h2>
      </div>
      <div class="flex border-b border-[#e5e7eb] mb-[16px]">
        <button v-for="tab in ['approve', 'reject', 'defer']" :key="tab"
          ...
          class="px-[16px] py-[9px] text-[18px] leading-[27px] font-normal capitalize border-b-2 transition-colors"
      ...
      <div class="space-y-[12px]">
        <div>
          ...
          <input type="text" value="₱145,000.00" class="w-full text-[18px] leading-[27px] font-light border border-[#e5e7eb] rounded-[7px] px-[12px] py-[9px] outline-none focus:border-[#224e22] text-[#171A1F]" />
        </div>
        <div>
          <label class="text-[20px] leading-[28px] font-normal text-[#171A1F] block mb-[5px]">Legal Findings</label>
          <textarea rows="3" class="w-full text-[18px] leading-[27px] font-light border border-[#e5e7eb] rounded-[7px] px-[12px] py-[9px] outline-none focus:border-[#224e22] resize-none text-[#171A1F]">All statutory requirements met. Claim is eligible for compensation under applicable CPIS guidelines.</textarea>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-[12px] border border-[#f0f0f0] shadow-sm p-[20px]">
      <div class="flex items-center gap-[10px] mb-[10px]">
        <div class="w-[4px] h-[18px] bg-[#224e22] rounded-full"></div>
        <h2 class="text-[30px] leading-[45px] font-normal text-[#234F23]">Resolution Notes <span class="text-[16px] leading-[24px] font-light text-[#d0272a] ml-[4px]">(Mandatory)</span></h2>
      </div>
      <textarea rows="4" placeholder="Enter the official board resolution notes and any conditions attached to the decision..." class="w-full text-[18px] leading-[27px] font-light border border-[#e5e7eb] rounded-[8px] px-[12px] py-[10px] outline-none focus:border-[#224e22] resize-none text-[#171A1F] placeholder-[#9ca3af]"></textarea>
    </div>
      ...
      <table class="w-full">
        <thead>
          <tr class="border-b border-[#f0f0f0] bg-[#fafafa]">
            <th class="px-[12px] py-[9px] text-[18px] leading-[27px] font-normal text-[#202224] uppercase text-left">Member Name</th>
            <th class="px-[12px] py-[9px] text-[18px] leading-[27px] font-normal text-[#202224] uppercase text-left">Vote</th>
            <th class="px-[12px] py-[9px] text-[18px] leading-[27px] font-normal text-[#202224] uppercase text-left">Timestamp</th>
        ...
        <tbody>
          <tr v-for="v in votes" :key="v.member" class="border-b border-[#f8f9fa] hover:bg-[#fafafa]">
            <td class="px-[12px] py-[10px] text-[18px] leading-[27px] font-normal text-[#202224] opacity-80">{{ v.member }}</td>
            <td class="px-[12px] py-[10px]">
              <button class="px-[10px] py-[3px] rounded-[5px] text-[15px] leading-[22px] font-light text-[#1B1F25] transition-colors"
                :class="v.vote === 'Approve' ? 'bg-[#d1fae5]' : 'bg-[#f3f4f6] hover:bg-[#e5e7eb]'">
                {{ v.vote }}
              </button>
            </td>
            <td class="px-[12px] py-[10px] text-[18px] leading-[27px] font-normal text-[#202224] opacity-80">{{ v.timestamp }}</td>
            <td class="px-[12px] py-[10px]">
              <span class="px-[8px] py-[2px] rounded-full text-[15px] leading-[22px] font-light text-[#1B1F25] flex items-center justify-center h-[23px]"
                :class="v.status === 'Voted' ? 'bg-[#d1fae5]' : 'bg-[#ede9fe]'">
                {{ v.status }}
              </span>
            </td>
          </tr>
