...
<template>
  <main class="flex-1 w-full px-4 md:px-6 2xl:px-10 pt-5 2xl:pt-6 pb-8 mx-auto">
    ...
    <div class="flex flex-col 2xl:flex-row items-stretch 2xl:items-start gap-4 lg:gap-6 w-full animate-fade-in-up">
      ...
      <div
        ...
        <div class="pt-6 lg:pt-8 px-6 lg:px-8 pb-5 lg:pb-6 relative flex items-center">
          ...
          <h3 class="text-[22px] md:text-[26px] 2xl:text-[30px] font-normal text-[#202224] mb-0 ml-[10px]">
        ...
        <div class="flex-1 px-6 lg:px-8 pb-6 lg:pb-8 flex flex-col">
          ...
          <div
            ...
            <img src="@/assets/icons/CSV.svg" class="w-[50px] sm:w-[66px] h-auto mb-5 lg:mb-6" alt="CSV Icon" />
            <p
            ...
            <p class="text-[12px] lg:text-[14px] text-[#616161] font-light text-center leading-relaxed px-4">
      ...
      <div
        ...
        <div class="flex justify-between items-center mb-5 lg:mb-6 relative">
          <div class="absolute left-[-16px] lg:left-[-32px] h-6 lg:h-8 w-1.5 bg-[#224E22] rounded-r-1.5"></div>
          <h3
        ...
        <p class="text-[14px] md:text-[16px] 2xl:text-[18px] text-[#171A1F] mb-6 lg:mb-8 font-light">
        ...
        <div class="bg-[#FCFAEE] rounded-[16px] p-4 lg:p-6 flex flex-col flex-1">
          ...
          <div class="bg-[#F2F4F2] rounded-[8px] p-1.5 mb-5 lg:mb-6">
            <div
              ...
              <span class="text-[15px] md:text-[17px] 2xl:text-[18px] text-[#171A1F] font-light">Validate Data</span>
            </div>
          </div>

          <p class="text-[16px] md:text-[18px] 2xl:text-[20px] text-[#000] font-normal capitalize mb-2">
          ...
          <div class="bg-[#F2F4F2] rounded-[8px] p-1.5 mb-5 lg:mb-6">
            <div
              ...
              <span class="text-[15px] md:text-[17px] 2xl:text-[18px] text-[#171A1F] font-light">Finalize Dataset</span>
            </div>
          </div>
          <p class="text-[16px] md:text-[18px] 2xl:text-[20px] text-[#000] font-normal capitalize mb-2">
            Transfer To Template
          ...
          <!-- System Notice Block -->
          <div class="bg-white border border-[#E5E7EB] rounded-[8px] p-4 mb-4 lg:mb-5 shadow-sm">
            <h4 class="text-[16px] md:text-[18px] 2xl:text-[20px] text-[#171A1F] font-normal mb-2">
              System Notice
            </h4>
            <p class="text-[14px] md:text-[16px] 2xl:text-[18px] text-[#171A1F] font-light leading-relaxed">
          ...
          <div class="bg-white border border-[#E5E7EB] rounded-[8px] p-4 shadow-sm">
            <div class="flex items-center gap-1.5 mb-1">
              <h4 class="text-[16px] md:text-[18px] 2xl:text-[20px] text-[#171A1F] font-normal capitalize">
                Need Help?
              </h4>
              <InfoIcon class="w-3 h-3 lg:w-3.5 lg:h-3.5 text-[#6b7280]" />
            </div>
            <p class="text-[10px] md:text-[11px] text-[#171A1F] leading-snug italic font-normal">
