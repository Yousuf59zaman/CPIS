...
function statusColor(s: string) {
  if (s === 'In Progress') return 'bg-[#dbeafe] text-[#1e40af]'
  ...
  <main class="flex flex-col gap-[16px] 2xl:gap-[20px] p-[20px] 2xl:p-[24px]">
    ...
    <div class="bg-white rounded-[12px] border border-[#f0f0f0] shadow-sm p-[16px]">
      <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-[10px] mb-[10px]">
        <div>
          <label class="text-[10px] text-[#6b7280] block mb-[4px]">Assigned Unit</label>
        ...
        <div>
          <label class="text-[10px] text-[#6b7280] block mb-[4px]">Task Status</label>
          <select class="w-full text-[11px] border border-[#e5e7eb] rounded-[6px] px-[8px] py-[7px] outline-none text-[#374151]">
        ...
        <div>
          <label class="text-[10px] text-[#6b7280] block mb-[4px]">Task Priority</label>
          <select class="w-full text-[11px] border border-[#e5e7eb] rounded-[6px] px-[8px] py-[7px] outline-none text-[#374151]">
        ...
        <div>
          <label class="text-[10px] text-[#6b7280] block mb-[4px]">Date Range</label>
          <select class="w-full text-[11px] border border-[#e5e7eb] rounded-[6px] px-[8px] py-[7px] outline-none text-[#374151]">
        ...
        <div>
          <label class="text-[10px] text-[#6b7280] block mb-[4px]">Search</label>
          <input type="text" placeholder="Search tasks..." class="w-full text-[11px] border border-[#e5e7eb] rounded-[6px] px-[8px] py-[7px] outline-none focus:border-[#224e22] text-[#374151]" />
        </div>
      </div>
      <button class="w-full py-[8px] bg-[#1d4a1d] hover:bg-[#163a16] text-white text-[12px] font-medium rounded-[7px] transition-colors">
        Reset
      </button>
    </div>
    ...
    <div class="bg-white rounded-[12px] border border-[#f0f0f0] shadow-sm p-[20px]">
      <div class="flex items-center gap-[10px] mb-[14px]">
        ...
        <h2 class="text-[16px] font-semibold text-[#171a1f]">My Queue Tasks List</h2>
      </div>
        ...
        <table class="w-full min-w-[700px]">
          <thead>
            <tr class="border-b border-[#f0f0f0] bg-[#fafafa]">
              ...
              <th class="px-[12px] py-[9px] text-[10px] font-medium text-[#6b7280] uppercase text-left">Claim Ref</th>
              ...
              <th class="px-[12px] py-[9px] text-[10px] font-medium text-[#6b7280] uppercase text-left">Task</th>
          ...
          <tbody>
            <tr v-for="t in tasks" :key="t.ref" class="border-b border-[#f8f9fa] hover:bg-[#fafafa]">
              ...
              <td class="px-[12px] py-[10px] text-[12px] font-medium text-[#1d4a1d]">{{ t.ref }}</td>
              <td class="px-[12px] py-[10px] text-[12px] text-[#374151]">{{ t.claimant }}</td>
              <td class="px-[12px] py-[10px] text-[12px] text-[#374151]">{{ t.type }}</td>
              <td class="px-[12px] py-[10px] text-[12px] text-[#374151]">{{ t.unit }}</td>
              <td class="px-[12px] py-[10px] text-[12px] text-[#374151]">{{ t.task }}</td>
              <td class="px-[12px] py-[10px]"><span class="px-[8px] py-[2px] rounded-full text-[10px] font-medium" :class="statusColor(t.status)">{{ t.status }}</span></td>
              <td class="px-[12px] py-[10px]"><span class="px-[8px] py-[2px] rounded-full text-[10px] font-medium" :class="priorityColor(t.priority)">{{ t.priority }}</span></td>
